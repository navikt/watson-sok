...
type IndividuelleMeldekortAccordionProps = {
  fraDato: string;
  tilDato: string;
};

/**
 * Viser en utvidbar liste med individuelle meldekort for dagpenger,
 * med navigasjon mellom meldekort og en daglig aktivitetsvisning.
 */
export function IndividuelleMeldekortAccordion({
  fraDato,
  tilDato,
}: IndividuelleMeldekortAccordionProps) {
...
const MeldekortVisning = ({
  ...
  return (
    <Accordion>
      <AccordionItem>
        <AccordionHeader>
          Vis individuelle meldekort ({sorterteMeldekort.length})
        </AccordionHeader>
        <AccordionContent>
