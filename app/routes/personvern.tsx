  ...
  return (
    <Page>
      <PageBlock width="text" gutters>
        ...
        <BodyLong spacing>
          Alle søk du gjør på tjenesten blir lagret i en audit-logg. Dette
          gjøres for å sikre sporbarhet av alle oppslag som gjøres i tjenesten,
          og for å kunne vise tjenestlig behov for oppslag.
        </BodyLong>
        <BodyLong spacing>
